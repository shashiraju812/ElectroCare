...
class _OwnerLoginScreenState extends State<OwnerLoginScreen> {
  ...
  static const Color _textOnTheme = Color(0xFF3E2723);
              ...
              Container(
                    ...
                    decoration: BoxDecoration(
                      gradient: const LinearGradient(
                        colors: [_themeColor, _themeColorDark],
                        ...
                        children: [
                          TextButton(
                            ...
                            child: Text(
                              ...
                              style: const TextStyle(color: _themeColorDark),
                            ),
                          ),
                        ],
                      ),
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color: isSelected ? _themeColorDark : AppColors.igGrey,
          ),
        ),
        child: Center(
          child: Text(
            text,
            style: GoogleFonts.outfit(
              color: isSelected ? _themeColorDark : AppColors.textGrey,
